...
export const MODULE_DEFINITIONS: Record<string, ModuleDefinition> = {
  dental: {
    ...
    features: [
      { key: 'odontogram', name: 'Odontograma Digital', description: 'Grafico interactivo dental' },
      { key: 'dental-treatment-plans', name: 'Planes de Tratamiento Dental', description: 'Planificacion con codigos CDT' },
      { key: 'periodontal-chart', name: 'Carta Periodontal', description: 'Sondaje 6 puntos, sangrado, movilidad' },
      { key: 'dental-imaging', name: 'Imagenes Dentales', description: 'Radiografias y fotos intraorales' },
      { key: 'lab-cases', name: 'Laboratorio Dental', description: 'Seguimiento de trabajos de laboratorio' },
      { key: 'dental-recall', name: 'Sistema de Recall', description: 'Recordatorios y seguimiento periodico' },
      { key: 'fee-schedule', name: 'Tarifario', description: 'Tarifas por procedimiento y seguro' },
      { key: 'procedure-consent', name: 'Consentimiento por Procedimiento', description: 'Formularios de consentimiento informado' },
    ],
    models: [
      'Odontogram', 'OdontogramTooth', 'TreatmentPlan', 'TreatmentPlanItem',
      'PeriodontalExam', 'PeriodontalReading', 'DentalImage', 'LabCase',
      'DentalRecall', 'FeeSchedule', 'FeeScheduleItem', 'ProcedureConsent',
    ],
    apiPrefix: '/api',
