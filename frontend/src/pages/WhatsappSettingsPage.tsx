    ...
    return (
        <div className="space-y-6">
            <div className="flex justify-between items-center">
                <div>
                    <h1 className="text-2xl font-bold tracking-tight text-gray-900 dark:text-gray-100">Integración de WhatsApp</h1>
            ...
            <div className="grid grid-cols-1 lg:grid-cols-2 gap-6">
                ...
                <div className="bg-white dark:bg-gray-800 rounded-xl p-6 shadow-sm border border-gray-200 dark:border-gray-700">
                    ...
                    <div className="flex flex-col items-center justify-center p-8 min-h-[300px] border-2 border-dashed border-gray-200 dark:border-gray-700 rounded-lg bg-gray-50 dark:bg-gray-900/50">
                        {isLoadingStatus ? (
                            ...
                            <div className="text-center space-y-4">
                                ...
                                <div>
                                    <h3 className="text-xl font-bold text-green-600 dark:text-green-400">Conectado</h3>
                            ...
                            <div className="text-center">
                                ...
                                <div className="bg-white p-4 rounded-lg shadow-sm inline-block">
                                    <img src={statusData.qrCode} alt="WhatsApp QR Code" className="w-64 h-64" />
                                </div>
                            ...
                            <div className="text-center">
                                <p className="text-gray-500">Esperando inicialización...</p>
                            </div>
                        )}
                    </div>
                </div>
                ...
                <div className="bg-white dark:bg-gray-800 rounded-xl p-6 shadow-sm border border-gray-200 dark:border-gray-700">
                    ...
                    <form onSubmit={handleSendTest} className="space-y-4">
                        ...
                        <button
                            ...
                            className="w-full flex items-center justify-center gap-2 px-4 py-2 bg-blue-600 hover:bg-blue-700 disabled:bg-gray-300 dark:disabled:bg-gray-700 disabled:cursor-not-allowed text-white rounded-lg transition-colors font-medium"
                        >
