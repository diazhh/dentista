  ...
  return (
    <div className="space-y-6">
      <div className="flex justify-between items-center">
        <div>
          <h1 className="text-2xl font-bold text-gray-900">Logs de Emails</h1>
          <p className="text-gray-600 mt-1">Historial de emails enviados por el sistema</p>
        </div>
      </div>
      ...
      <div className="bg-white p-4 rounded-lg shadow-sm border">
        <div className="flex items-center gap-4">
          ...
          <div>
            <label className="text-sm text-gray-600 mr-2">Límite:</label>
            <select
              value={filter.limit}
        ...
        <div className="fixed inset-0 bg-black bg-opacity-50 flex items-center justify-center z-50">
          <div className="bg-white rounded-lg p-6 w-full max-w-3xl max-h-[90vh] overflow-y-auto">
            <div className="flex justify-between items-center mb-4">
              <h2 className="text-xl font-bold">Detalles del Email</h2>
              <button
            ...
            <div className="space-y-4">
              ...
              <div>
                ...
                <p className="text-sm text-gray-900">{selectedLog.to}</p>
              </div>

              <div>
                <p className="text-sm font-medium text-gray-700">Remitente:</p>
                <p className="text-sm text-gray-900">{selectedLog.from}</p>
              </div>
              ...
              <div className="grid grid-cols-2 gap-4">
                ...
                {selectedLog.sentAt && (
                  <div>
                    <p className="text-sm font-medium text-gray-700">Enviado:</p>
                    <p className="text-sm text-gray-900">
              ...
              {selectedLog.openedAt && (
                <div>
                  <p className="text-sm font-medium text-gray-700">Abierto:</p>
                  <p className="text-sm text-gray-900">
              ...
              {selectedLog.clickedAt && (
                <div>
                  <p className="text-sm font-medium text-gray-700">Click:</p>
                  <p className="text-sm text-gray-900">
              ...
              {selectedLog.error && (
                <div>
                  ...
                  <pre className="mt-1 p-3 bg-red-50 border border-red-200 rounded-lg text-sm text-red-900 whitespace-pre-wrap">
                    {selectedLog.error}
                  </pre>
                </div>
              )}
              ...
              {selectedLog.metadata && (
                <div>
                  ...
                  <pre className="mt-1 p-3 bg-gray-50 border rounded-lg text-sm text-gray-900 whitespace-pre-wrap">
