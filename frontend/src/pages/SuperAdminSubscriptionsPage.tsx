  ...
  return (
    <div className="space-y-6">
      ...
      <div>
        ...
        <p className="text-gray-600">Administra planes y facturación de todos los tenants</p>
      </div>
      ...
      <div className="grid grid-cols-1 md:grid-cols-4 gap-4">
        ...
        <div className="bg-white p-6 rounded-lg shadow">
          <div className="flex items-center justify-between">
            <div>
              <p className="text-sm text-gray-600">ARR Total</p>
              <p className="text-2xl font-bold text-gray-900">${(totalMRR * 12).toLocaleString()}</p>
            </div>
      ...
      <div className="bg-white p-6 rounded-lg shadow">
        ...
        <div className="grid grid-cols-1 md:grid-cols-3 gap-4">
          <div className="border-2 border-blue-200 rounded-lg p-4">
            <h4 className="text-lg font-bold text-blue-600">STARTER</h4>
            <p className="text-3xl font-bold text-gray-900 mt-2">$29<span className="text-sm text-gray-500">/mes</span></p>
          ...
          <div className="border-2 border-purple-200 rounded-lg p-4 bg-purple-50">
            <h4 className="text-lg font-bold text-purple-600">PROFESSIONAL</h4>
            <p className="text-3xl font-bold text-gray-900 mt-2">$79<span className="text-sm text-gray-500">/mes</span></p>
            <ul className="mt-4 space-y-2 text-sm text-gray-600">
          ...
          <div className="border-2 border-yellow-200 rounded-lg p-4">
            <h4 className="text-lg font-bold text-yellow-600">ENTERPRISE</h4>
            <p className="text-3xl font-bold text-gray-900 mt-2">$199<span className="text-sm text-gray-500">/mes</span></p>
            <ul className="mt-4 space-y-2 text-sm text-gray-600">
